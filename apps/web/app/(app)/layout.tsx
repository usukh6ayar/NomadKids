 ...
 * under the label and icon the mock-up gives a fourth, catch-all tab.
 *
 * ★★ "Зураг" is a plain link now, no popup at all. It goes straight to the
 * first child's `/overview` — the same "first child, most families only ever
