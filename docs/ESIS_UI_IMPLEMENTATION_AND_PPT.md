...
- Өдөр тутмын ажил дээр context action хэрэглэнэ: хүүхэд импорт, ирц, орц,
  технологийн картын header дээр **"ESIS-ээс татах"** байрлана.
- ★ **Захирлын дэлгэцүүд дээр dialog биш, мөр нь шууд харагдана** — 2026-09-08,
  захиалагчийн хүсэлтээр: "холбосны дараа мэдээллүүд нь орж ирж байна гэж
  харна". `EsisDataPanel` нь `/settings`-ийн "ESIS мэдээлэл" хэсэгтэй ижил
  зарчмаар ажиллана: **утга нь эхний зурагдалтад дэлгэц дээр байна**, товч нь
  түүнийг нээдэггүй, харин бодит хариугаар **солино**. Энэ дараалал нь badge-ийг
  үнэн болгож хадгална — товч дарсны дараа л мэдээлэл гарч ирдэг дэлгэц нь
  уншигчид "товч яам руу залгалаа" гэж бодуулна.

  | Дэлгэц                | ESIS сервис                     | Асуулт                             |
  | --------------------- | ------------------------------- | ---------------------------------- |
  | `/admin/kindergarten` | `organization` (16 талбар)      | Албан нэр, ангилал, засаг захиргаа |
  | `/admin/groups`       | `groups`                        | Бүлэг + ESIS-д бүртгэлтэй нь багш  |
  | `/admin/users`        | `teachers`, `staff`             | Багшийн томилгоо ба ажил эрхлэлт   |
  | `/admin/school-years` | `academicYearStatuses`          | Нээсэн, хаасан огноо тулгах        |
  | `/children`           | `students`, `studentByRegister` | Элсэлт тулгах, РД-аар нэгийг олох  |

  Багш эдгээрийг харахгүй: панел нь `hasRole("ADMIN")` дээр `null` буцаана, ард
  байгаа route нь бусад бүх хүнд 404 өгнө.
