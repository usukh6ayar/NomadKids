...
★★★ **Энэ deployment дээр нүүлгэх өгөгдөл байхгүй.** Захиалагч 2026-09-02-нд
баталсан: `nomadkids.mn` (Vercel) ба `api.nomadkids.mn` (Railway) дээрх бүх
өгөгдөл нь туршилтынх, бодит цэцэрлэг, бодит хүүхэд, бодит хэрэглэгч байхгүй.

Тиймээс шилжилт нь ердөө домэйн заах ажил:

1. Түр нэр дээр стек ажиллаж, §3.7-гийн шалгалт ногоон болсон байх
2. `.env.production` дээрх гурван домэйныг жинхэнэ нэр рүү солих
   (`WEB_DOMAIN`, `API_DOMAIN`, `CORS_ORIGINS`, `WEB_ORIGIN`, мөн
   `QPAY_CALLBACK_URL`), дараа нь **`--force-recreate`** (§3.4-ийн ★★)
3. Cloudflare дээрх A бичлэгүүдийг VPS рүү заах — **саарал үүл**
4. `prisma/seed.ts`-ээр администратор үүсгэж, жинхэнэ цэцэрлэгээ бүртгэх
5. **Railway болон Vercel-ийг сар орчим үлдээх** — эргэж буцах зам, §7-д
   зориудаар нээлттэй үлдээсэн
6. QPay-д callback хаягийн өөрчлөлтийг мэдэгдэх
   (`api-vps` → `api.nomadkids.mn`)

---

★ **Хэрэв бодит өгөгдөлтэй систем шилжүүлэх бол** — өөр deployment дээр,
эсвэл энэ нь ажиллаж эхэлсний дараа — доорх нь хүчинтэй хэвээр:
...
Хоёулаа **нэг цэгээс** авагдсан байх ёстой. Эс тэгвэл сэргээсэн сан нь байхгүй
объект руу заасан `storageKey`-тэй мөрүүдтэй гарна: эвдэрсэн зурагтай
портфолио, 404 буцаах медиа. §4-т бичсэн яг тэр зовлон, эсрэг чиглэлд.

Мөн Railway дээрх бичилтийг dump авахын өмнө зогсоох богино засварын цонх
хэрэгтэй болно.

## 4. Нөөцлөлт — эхний бодит хэрэглэгчийн өмнө заавал

★★★ **Тавих ёстой яг тэр өдөр: эхний жинхэнэ цэцэрлэг эхний зургаа
байршуулах өдөр.**

Энэ хэсэг нь "заавал, шууд" гэж бичигдсэн байсан бөгөөд 2026-09-02-ны байдлаар
тийм биш: сервер дээрх бүх өгөгдөл нь `seed-showcase.ts`-ийн үүсгэсэн демо
цэцэрлэг — командаар дахин үүсгэж болно, нөөцлөх зүйлгүй. Тэр өгүүлбэрийг
байгаагаар нь үлдээвэл унших хүн бүр "одоохондоо хамаагүй" гэж дүгнээд,
**хамаатай болсон өдрийг нь анзаарахгүй** өнгөрөх байсан.

Тэр өдөр яг тодорхой. Түүнээс өмнө диск үхвэл нэг команд алдана; түүнээс хойш
диск үхвэл **хүүхэд бүрийн зураг, ажиглалт, санхүүгийн бүртгэл** алдана —
дахин үүсгэх боломжгүй зүйлс. Дунд нь завсар байхгүй.

**Шалгах:**

```bash
# 0-оос их байвал энэ хэсэг идэвхтэй болсон
docker compose -f docker-compose.prod.yml exec -T db \
  psql -U kinder -d kinder -tAc "select count(*) from media_files"
```
...
Railway дээр Postgres тусдаа managed сервис байсан бөгөөд шөнө бүр snapshot
авдаг байсан — хэн ч бодох шаардлагагүй. Одоо бүгд нэг машин дээр: диск үхвэл
бүгд алга, **нөөцлөлт нь цорын ганц хамгаалалт**.

★ 2026-09-02-ны байдлаар энэ нь онолын эрсдэл: сервер дээр демо өгөгдөл л
байгаа. Эхний бодит цэцэрлэг ороход тэр өдрөө бодит эрсдэл болно — §4.
